...
$packager->recursiveCopy('src', 'GuzzleHttpFork', ['php']);
$packager->recursiveCopy('vendor/guzzlehttp/promises/src', 'GuzzleHttpFork/Promise');
$packager->recursiveCopy('vendor/guzzlehttp/psr7/src', 'GuzzleHttpFork/Psr7');
$packager->recursiveCopy('vendor/psr/http-message/src', 'Psr/Http/Message');

$packager->createAutoloader([
    'GuzzleHttpFork/functions_include.php',
    'GuzzleHttpFork/Psr7/functions_include.php',
    'GuzzleHttpFork/Promise/functions_include.php',
]);
