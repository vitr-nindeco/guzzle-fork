...
You can create a request using the ``GuzzleHttpFork\Psr7\Request`` class:
...
You can create a response using the ``GuzzleHttpFork\Psr7\Response`` class:
...
.. code-block:: php
    ...
    $response = GuzzleHttpFork\get('http://httpbin.org/get');
...
function from the ``GuzzleHttpFork\Psr7`` namespace --
``GuzzleHttpFork\Psr7\stream_for``. This function accepts strings, resources,
...
.. code-block:: php
    ...
    use GuzzleHttpFork\Stream\Stream;
...
.. code-block:: php
    ...
    $request = new \GuzzleHttpFork\Psr7\Request('MOVE', 'http://httpbin.org/move');
...
The best way to create a stream is using the ``GuzzleHttpFork\Psr7\stream_for``
